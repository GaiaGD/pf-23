...
function Header() {
    ...
    const {planet, toggleMercury, toggleVenus, toggleMars, toggleJupiter, toggleSaturn, toggleUranus, toggleNeptune} = useContext(PlanetTheme)
    console.log(planet.first)
    ...
    return (
        <div className='sticky top-0 z-50 border-b-[0.1px] border-white-100 border-opacity-20 flex justify-between items-center'>
            <div className='header-planets flex items-center max-w-xl m-5'>
                <div className="mr-14 opacity-30" id='mercury' onClick={toggleMercury}>
                    <img className="w-full" src='src/assets/img/mercury.png'/>
                </div>
                <div className="mr-14 opacity-30" id='venus' onClick={toggleVenus}>
                    <img src='src/assets/img/venus.png'/>
                </div>
                <div className="mr-14" id='mars' onClick={toggleMars}>
                    <img src='src/assets/img/mars.png'/>
                </div>
                <div className="mr-8 opacity-30" id='jupiter' onClick={toggleJupiter}>
                    <img className="w-full" src='src/assets/img/jupiter.png'/>
                </div>
                <div className="mr-8 opacity-30" id='saturn' onClick={toggleSaturn}>
                    <img src='src/assets/img/saturn.png'/>
                </div>
                <div className="mr-14 opacity-30" id='uranus' onClick={toggleUranus}>
                    <img src='src/assets/img/uranus.png'/>
                </div>
                <div className="mr-14 opacity-30" id='neptune' onClick={toggleNeptune}>
